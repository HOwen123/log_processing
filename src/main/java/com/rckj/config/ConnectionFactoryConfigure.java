package com.rckj.config;

import com.rckj.rabbitmq.MessageConsumer;
import com.rckj.rabbitmq.MessageConsumer2;
import com.rckj.rabbitmq.MsgSendConfirmCallBack;
...
public class ConnectionFactoryConfigure {
    ...
    /** 消息交换机的名字*/
    public static final String EXCHANGE = "seallog";
